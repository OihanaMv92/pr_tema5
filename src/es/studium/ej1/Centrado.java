...
ComponentListener // hace que cuando el usuario cambia de tamaño el frame usa el metodo getWidth y GetHight
{
	...
	public Centrado()
	{
		...
		setVisible(true); // para poner los botones en cierta distribucion
	}
