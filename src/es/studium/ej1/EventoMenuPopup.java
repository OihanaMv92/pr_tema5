...
public class EventoMenuPopup extends Frame implements ActionListener,// menu para actuar con lo que hay dentro
WindowListener
{
	...
	public void actionPerformed(ActionEvent ae) // cuando pulse boton o opciones
	{
		Object a;
